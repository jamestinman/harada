...
<article class="content-page space-y-24 pb-12">
	...
	<div class="relative overflow-hidden rounded-3xl border border-emerald-200 bg-emerald-50 p-8 shadow-sm sm:p-12 dark:border-emerald-900/50 dark:bg-emerald-950/40">
