-- Per-goal parent for tasks linked to multiple goals.
-- Primary goal hierarchy remains on tasks.parent_id; secondary appearances use task_goal_links.parent_id.
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO task_goal_links (
      id, user_id, task_id, goal_index, ordering, parent_id, created_at, updated_at, deleted_at
    )
    VALUES (
      row_data->>'id',
